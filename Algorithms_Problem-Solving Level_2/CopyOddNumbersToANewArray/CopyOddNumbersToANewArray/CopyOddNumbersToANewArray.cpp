...
void CopyOddNumberToANewArray(int arrSource[100], int arrDestination[100], int arrLength, int& arrDestinationLength)
{
	for (int i = 0;i < arrLength;i++)
	{
		if (arrSource[i] % 2 != 0)
...
int main()
{
	...
	CopyOddNumberToANewArray(Array, Array2, ArrLength, Arr2Length);
